(function() {
    function r(a, c, d) {
        ...
        a._chain && (a = a._wrapped), c._chain && (c = c._wrapped);
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = b), exports._ = b) : s._ = b, b.VERSION = "1.3.3";
    ...
    b.map = b.collect = function(a, c, b) {
        var e = [];
        return a == null ? e : z && a.map === z ? a.map(c, b) : (j(a, function(a, g, h) {
            e[e.length] = c.call(b, a, g, h);
        }), a.length === +a.length && (e.length = a.length), e);
    }, b.reduce = b.foldl = b.inject = function(a, c, d, e) {
        var f = arguments.length > 2;
        a == null && (a = []);
        if (A && a.reduce === A) return e && (c = b.bind(c, e)), f ? a.reduce(c, d) : a.reduce(c);
        j(a, function(a, b, i) {
        ...
        var f = arguments.length > 2;
        a == null && (a = []);
        if (B && a.reduceRight === B) return e && (c = b.bind(c, e)), f ? a.reduceRight(c, d) : a.reduceRight(c);
        var g = b.toArray(a).reverse();
        return e && !f && (c = b.bind(c, e)), f ? b.reduce(g, c, d, e) : b.reduce(g, c);
    }, b.find = b.detect = function(a, c, b) {
        var e;
        return G(a, function(a, g, h) {
            if (c.call(b, a, g, h)) return e = a, !0;
        }), e;
    }, b.filter = b.select = function(a, c, b) {
        var e = [];
        return a == null ? e : C && a.filter === C ? a.filter(c, b) : (j(a, function(a, g, h) {
            c.call(b, a, g, h) && (e[e.length] = a);
        }), e);
    }, b.reject = function(a, c, b) {
        var e = [];
        return a == null ? e : (j(a, function(a, g, h) {
            c.call(b, a, g, h) || (e[e.length] = a);
        }), e);
    }, b.every = b.all = function(a, c, b) {
        var e = !0;
        return a == null ? e : D && a.every === D ? a.every(c, b) : (j(a, function(a, g, h) {
    ...
    var G = b.some = b.any = function(a, c, d) {
        c || (c = b.identity);
        var e = !1;
        return a == null ? e : E && a.some === E ? a.some(c, d) : (j(a, function(a, b, h) {
    ...
    b.include = b.contains = function(a, c) {
        ...
        return j(a, function(a, b, h) {
            b = c ? c.call(d, a, b, h) : a, b >= e.computed && (e = {
                value: a,
                computed: b
            });
        }), e.value;
        ...
        return b.reduce(a, function(a, e) {
            return b.isArray(e) ? a.concat(c ? e : b.flatten(e)) : (a[a.length] = e, a);
        }, []);
    }, b.without = function(a) {
        return b.difference(a, i.call(arguments, 1));
    }, b.uniq = b.unique = function(a, c, d) {
        var d = d ? b.map(a, d) : a, e = [];
        return a.length < 3 && (c = !0), b.reduce(d, function(d, g, h) {
            if (c ? b.last(d) !== g || !d.length : !b.include(d, g)) d.push(g), e.push(a[h]);
            return d;
        }, []), e;
    }, b.union = function() {
    ...
    b.bind = function(a, c) {
        ...
        return e = i.call(arguments, 2), d = function() {
        ...
        var c = i.call(arguments, 1);
        return c.length == 0 && (c = b.functions(a)), j(c, function(c) {
            a[c] = b.bind(a[c], a);
        }), a;
        ...
        return function() {
            return d = this, e = arguments, f || (f = setTimeout(function() {
                f = null, h && a.apply(d, e), j();
            }, c)), g ? h = !0 : i = a.apply(d, e), j(), g = !0, i;
        };
    }, b.debounce = function(a, b, d) {
        var e;
        return function() {
            var f = this, g = arguments;
            d && !e && a.apply(f, g), clearTimeout(e), e = setTimeout(function() {
        ...
        var b = !1, d;
        return function() {
            return b ? d : (b = !0, d = a.apply(this, arguments));
        };
    }, b.wrap = function(a, b) {
        return function() {
        ...
        return j(i.call(arguments, 1), function(b) {
            for (var d in b) a[d] = b[d];
        }), a;
    }, b.pick = function(a) {
        var c = {};
        return j(b.flatten(i.call(arguments, 1)), function(b) {
            b in a && (c[b] = a[b]);
        }), c;
    ...
    var x = function(a, c) {
        ...
        m.prototype[a] = function() {
            ...
            return J.call(a, this._wrapped), x(c.apply(b, a), this._chain);
        };
    };
    b.mixin(b), j("pop,push,reverse,shift,sort,splice,unshift".split(","), function(a) {
        ...
        m.prototype[a] = function() {
            ...
            b.apply(d, arguments);
            var e = d.length;
            return (a == "shift" || a == "splice") && e === 0 && delete d[0], x(d, this._chain);
        };
